...
(function($, window, docuement){
    ...
    var $rec_title_entry = $('.rec_title_entry');
    var $rec_title_chars_left = $('.rec_title_chars_left');
    
    var $rec_text_entry = $('.rec_text_entry');
    var $rec_chars_left = $('.rec_chars_left');
    
    var $comment_text_entry = $('.comment_text_entry');
    var $comment_chars_left = $('.comment_chars_left');
    
    var $about_me_text_entry = $('.about_me_text_entry');
    var $about_me_chars_left = $('.about_me_chars_left');
